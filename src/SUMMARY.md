...
- [OSPFv2](./routing/ospfv2.md)
  - [DR Election](./routing/ospfv2-dr-election.md)
    - [DR LSAs](./routing/ospfv2-dr-lsas.md)
  - [LSA Types](./routing/ospfv2-lsa-types.md)
    - [Type 1 LSA - Router](./routing/ospfv2-type-1-lsa-router.md)
    - [Type 2 LSA - Network](./routing/ospfv2-type-2-lsa-network.md)
    - [Type 3 LSA - Summary](./routing/ospfv2-type-3-lsa-summary.md)
    - [Type 4 LSA - ASBR Summary](./routing/ospfv2-type-4-lsa-asbr-summary.md)
    - [Type 5 LSA - External](./routing/ospfv2-type-5-external.md)
  - [Network and LSA Chart](./routing/ospfv2-network-and-lsa-chart.md)
  - [LSA Default Routes](./routing/ospfv2-lsa-default-route.md)
  - [Network Types](./routing/ospfv2-network-types.md)
    - [Point-to-Multipoint](./routing/ospfv2-p2mp.md)
  - [LFA](./routing/ospfv2-lfa.md)
  - [Sham Links](./routing/ospfv2-sham-links.md)
  - [Incremental SPF](./routing/ospfv2-incremental-spf.md)

- [OSPFv3](./ospfv3.md)

- [EIGRP](./routing/eigrp.md)
  - [EIGRP Stub Routing](./routing/eigrp-stub-routing.md)
  
- [IS-IS](is-is.md)
  - [IS-IS Network Design](is-is-network-design.md)

- [BGP](./routing/bgp.md)
  - [Neighbor FSM](./routing/bgp-neighbor-fsm.md)
  - [Confederations](./routing/bgp-confederations.md)
  - [Route Reflectors](./routing/bgp-route-reflectors.md)
  - [Multipath](./routing/bgp-multipath.md)
  - [Multihop](./routing/bgp-multihop.md)
  - [Tuning](./routing/bgp-tuning.md)
  - [Load Balancing](./routing/bgp-load-balancing.md)
  - [Allowas-In](./routing/bgp-allowas-in.md)
  - [AS-Override](./routing/bgp-as-override.md)
